...
class UserToken extends Token
{
   ...
   // public   function getimg($userinfo){



   //      $info=curl_img($userinfo['headimgurl']);
   //      $imgBase64Code='';

   //      if ($info['code'] == 200) {
   //          $imgBase64Code = "data:image/jpeg;base64," . base64_encode($info['data']);
   //      }else{
   ...
   //          $src=md5($userinfo['openid']);
   //          $new_file = "./uploads/headhumb/{$src}{$type}";
   //      }
